...
class VacancyLoader:
    ...
    def data_transformation(self):
        ...
        self.tabdict['professional_roles'] = self.tabdict['professional_roles'].apply(ast.literal_eval)
        self.tabdict['CATEGORY'] = self.tabdict['professional_roles'].apply(lambda x: x[0]['id'] if x else None)
        self.tabdict.to_csv('./Back/bd/all_vacancies.csv', index=False)
        return self.tabdict
